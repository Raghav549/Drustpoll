    ...
    <SafeAreaView style={styles.safe}>
      <ScrollView contentInsetAdjustmentBehavior="automatic" contentContainerStyle={styles.content}>
        <View style={styles.header}>
          <View>
            <Text style={styles.eyebrow}>DRUSTPOLL</Text>
            <Text style={styles.title}>Your world, naturally.</Text>
          </View>
          <Link href="/shop" asChild>
            <Pressable style={styles.shopButton}><Text style={styles.shopText}>Shop</Text></Pressable>
          </Link>
        </View>

        <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.pills}>
          {topics.map((topic, index) => (
            <View key={topic} style={[styles.pill, index === 0 && styles.activePill]}>
              <Text style={[styles.pillText, index === 0 && styles.activePillText]}>{topic}</Text>
            </View>
          ))}
        </ScrollView>
        ...
        <View style={styles.hero}>
          ...
          <Text style={styles.heroBody}>A calm social feed built around relevance, variety, control and real connections—not endless noise.</Text>
        </View>
