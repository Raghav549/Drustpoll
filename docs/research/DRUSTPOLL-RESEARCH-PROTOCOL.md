...
- Recent 2026 HCI review on attention-capture dark patterns: optimize for meaningful flow, not compulsive dissociation.
...
## Definition of done
A feature is not considered production-ready merely because it works technically. It must also have evidence, accessibility review, privacy/security review, instrumentation, failure states, and a measurable user-value hypothesis.
