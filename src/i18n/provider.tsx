...
import { defaultLocale, getLocale, loadLocale, locales, saveLocale, t, type Locale } from './core';
...
export function I18nProvider({children}:{children:React.ReactNode}){
 ...
 const setLocale=async(code:string)=>{const next=getLocale(code);await saveLocale(next.code);setLocaleState(next.code);if(next.direction==='rtl')I18nManager.allowRTL(true);else I18nManager.allowRTL(false);};
