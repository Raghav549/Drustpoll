...
const items = [
  { href: '/', glyph: '◌', label: 'Home', hint: 'Your social context' },
  { href: '/search', glyph: '⌕', label: 'Explore', hint: 'Find people, ideas and products' },
  { href: '/reels', glyph: '✦', label: 'Create', hint: 'Create and express' },
  { href: '/messages', glyph: '↗', label: 'Connect', hint: 'Messages and notifications' },
  { href: '/profile', glyph: '○', label: 'You', hint: 'Profile and controls' },
] as const;
